        ...
        (compassRunnable = new BukkitRunnable() {
            ...
            public void run() {
                ...
                meta.setDisplayName(Language.COMPASS_FORMAT.format("blocks",
                        UtilityMethods.format(bounty.getTarget().getPlayer().getLocation().distance(player.getLocation()), true)));
                ...
                if (BountyHunters.getInstance().getConfigManager().trackingParticles && (ti = (ti + 1) % 20) < 3) {
