...
public class MySQLPlayerDataManager extends PlayerDataManager {
    ...
    public void saveData(PlayerData data) {
        try {
            ...
            BountyHunters.getInstance().getLogger().log(Level.SEVERE, "Could not save player data of " + data.getPlayerName() + ": " + exception.getMessage());
    ...
    public void loadData(PlayerData data) {
        try {
            ...
            if (titleFormat != null)
                try {
                    Validate.isTrue(levelManager.hasTitle("current-title"), "Could not load title from " + data.getPlayerName());
            ...
            if (quoteFormat != null)
                try {
                    Validate.isTrue(levelManager.hasAnimation(quoteFormat), "Could not load animation from " + data.getPlayerName());
            ...
            BountyHunters.getInstance().getLogger().log(Level.SEVERE, "Could not load player data of " + data.getPlayerName() + ": " + exception.getMessage());
        }
    }
